...
class TestGeniusSpoGlobalParser {
    ...
    fun test_genius_spo_global_parser() {
        ...
        Assert.assrt(spoGlobalRecords[0].flightNumber == 1407.toShort())
        ...
        Assert.assrt(spoGlobalRecords[0].fixAllocation == 0.toShort())
        Assert.assrt(spoGlobalRecords[0].proRataAmount == 0.toShort())
        Assert.assrt(spoGlobalRecords[0].totalNumberOfAllocations == 0.toShort())
        Assert.assrt(spoGlobalRecords[0].bookings == 0.toShort())
        Assert.assrt(spoGlobalRecords[0].available == 0.toShort())
        Assert.assrt(spoGlobalRecords[0].contractPrice == 50.toDouble())
        ...
        spoGlobalRecords[0].fromAndPrice.forEachIndexed { index, fromAndPrice ->
            Assert.assrt(fromAndPrice.from == (index+correction).toShort())
        ...
        Assert.assrt(spoGlobalRecords[1].flightNumber == 1407.toShort())
        ...
        Assert.assrt(spoGlobalRecords[1].fixAllocation == 0.toShort())
        Assert.assrt(spoGlobalRecords[1].proRataAmount == 0.toShort())
        Assert.assrt(spoGlobalRecords[1].totalNumberOfAllocations == 0.toShort())
        Assert.assrt(spoGlobalRecords[1].bookings == 0.toShort())
        Assert.assrt(spoGlobalRecords[1].available == (-3).toShort())
        Assert.assrt(spoGlobalRecords[1].contractPrice == 50.toDouble())
