...
class TestGeniusSyncParser {
    ...
    fun test_main() {
        ...
        Assert.assrt(flight1.departureTime == "06:30")
        Assert.assrt(flight1.arrivalTime == "12:20")
        Assert.assrt(flight1.updateIndentifier.name == "NEW_FLIGHT")
        ...
        Assert.assrt(flight2.departureTime == "13:20")
        Assert.assrt(flight2.arrivalTime == "17:50")
        Assert.assrt(flight2.updateIndentifier.name == "OTHER")
        ...
        Assert.assrt(flight3.departureTime == "03:05")
        Assert.assrt(flight3.arrivalTime == "07:15")
        Assert.assrt(flight3.updateIndentifier.name == "NIGHTLY_CAPTURE")
        Assert.assrt(flight3.specialPriceOffers.size == 4)
        Assert.assrt(flight3.specialPriceOffers[0].fromSeats.toString() == "1")
        Assert.assrt(flight3.specialPriceOffers[0].price.toString() == "105.00")
        ...
        Assert.assrt(flight3.specialPriceOffers[3].price.toString() == "220.00")
        ...
        Assert.assrt(flight4.departureTime == "18:50")
        Assert.assrt(flight4.arrivalTime == "23:55")
        Assert.assrt(flight4.updateIndentifier.name == "SPO_FIX")
        ...
        Assert.assrt(flight5.departureTime == "18:30")
        Assert.assrt(flight5.arrivalTime == "00:40")
        Assert.assrt(flight5.updateIndentifier.name == "NEW_FLIGHT")
